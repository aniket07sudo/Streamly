...
import {View,Text,StyleSheet, ImageProps,Image,FlatList,Dimensions,TouchableOpacity} from "react-native";
            ...
            <FlatList 
                ...
                renderItem={({item,index}) => {
                    ...
                    return (
                        ...
                        //     params:{ item }
                        // })}>
                        <TouchableOpacity key={item.id} onPress={() => navigation.push("MovieDetails", { item })}>
                            <View style={styles.tray}>
                                <SharedElement id={`image.${item.id}`}>
                                    <Image style={{width:135,height:278,overflow:"hidden",resizeMode:"cover"}} source={item.image} />
                                </SharedElement>
