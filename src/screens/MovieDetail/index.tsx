...
import { View, Image, Text, StyleSheet, Dimensions, StatusBar, ScrollView,TouchableOpacity, Platform } from "react-native";
        ...
        <Animated.ScrollView scrollEventThrottle={16} 
            ...
            <View style={styles.imageOuter}>
                ...
                <View style={[styles.imageWrapper]}>
                    <SharedElement id={`image.${item.id}`} style={{...StyleSheet.absoluteFillObject}}>
                        {/* <View style={{flex:1}}> */}
                            {Platform.OS === "ios" ? <Animated.Image style={[styles.imageContainer,ImageHeight]} source={require("../../assets/Banner/Aladdin.jpg")}  /> : <Image style={[styles.imageContainer]} source={require("../../assets/Banner/Aladdin.jpg")}  /> }
                        {/* </View> */}
                    </SharedElement>
                    <AnimateLinearGradient colors={['transparent', Colors.background]} style={[styles.linearGradient,animatedStyle]} />
                </View>
                ...
                <Animated.View style={[styles.imageTextContainer,animatedStyle]}>
                    ...
                    <SharedElement style={styles.starRatingContainer} id={`rating.${item.id}`} >
                        ...
                        <MediumText style={styles.tagText}>(128 Reviews)</MediumText>
                        </>
                    </SharedElement>
                </Animated.View>
            </View>
